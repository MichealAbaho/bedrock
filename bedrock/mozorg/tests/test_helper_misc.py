...
class TestPlatformImg(TestCase):
    ...
    def test_platform_img_no_optional_attributes(self):
        ...
        expected = (
            u'<img class="platform-img js" src="" data-src="/static/test.png" >'
            u'<noscript><img class="platform-img win" src="/static/test.png" >'
            u'</noscript>')
    ...
    def test_platform_img_with_optional_attributes(self):
        ...
        expected = (
            ...
            u'src="/static/test.png" data-test-attr="test"></noscript>')
        self.assertEqual(markup, jinja2.Markup(expected))
